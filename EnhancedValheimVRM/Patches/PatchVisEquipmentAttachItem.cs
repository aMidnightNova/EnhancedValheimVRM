...
namespace EnhancedValheimVRM
{
    ...
    internal static class PatchVisEquipmentAttachItem
    {
        ...
        )
        {
            ...
            // Using extension method to invoke private method 'CleanupInstance'
            __instance.InvokePrivateMethod("CleanupInstance", instance);

            if (enableEquipEffects)
            {
                // Using extension method to invoke private method 'EnableEquippedEffects'
            ...
            if (original.name == "attach_skin")
            {
                ...
                {
                    Logger.Log($"Mapping bones for SkinnedMeshRenderer: {componentsInChild.name}", Logger.LogLevel.Debug);
            ...
            // Using reflection to access internal interface 'IEquipmentVisual'
